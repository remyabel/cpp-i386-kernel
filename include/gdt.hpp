...
class Gdt {
    ...
    void gdt_init() {
        ...
        gdt_create_descriptor(
            1, {0xFFFF, 0, 0, 0x9A, 0xCF, 0}); // kernel code segment
        gdt_create_descriptor(
            2, {0xFFFF, 0, 0, 0x92, 0xCF, 0}); // kernel data segment
        gdt_create_descriptor(
            3, {0xFFFF, 0, 0, 0xFA, 0xCF, 0}); // user code segment
        gdt_create_descriptor(
            4, {0xFFFF, 0, 0, 0xF2, 0xCF, 0}); // user data segment
